    ...
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column label="报修提交时间" prop="orderBuildTime" sortable/>
          <el-table-column label="处理完成时间" prop="orderFinishTime" sortable/>
          <!--      操作栏-->
        ...
        <div>
          <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
              ...
              <el-form-item :style="finishTime" label="报修信息状态" prop="state">
                <el-radio v-model="form.state" label="完成">完成</el-radio>
                <el-radio v-model="form.state" label="已派遣">已派遣</el-radio>
                <el-radio v-model="form.state" label="未完成">未完成</el-radio>
              </el-form-item>
              <el-form-item label="报修提交时间" prop="orderBuildTime" style="margin-top: 27px">
                <el-date-picker
              ...
              <el-form-item :style="finishTime" label="处理完成时间" prop="orderFinishTime" style="margin-top: 27px">
                <el-date-picker
