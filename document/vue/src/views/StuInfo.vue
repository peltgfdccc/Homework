    ...
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column :show-overflow-tooltip="true" label="所在学院、班级" prop="email"/>
          <!--      操作栏-->
        ...
        <div>
          ...
          <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
              ...
              <el-form-item label="所在学院、班级" prop="email">
                <el-input v-model="form.email" style="width: 80%"></el-input>
              </el-form-item>
              <el-form-item label="在寝状态" prop="inRoom">
                <el-radio v-model="form.inRoom" label="是">是</el-radio>
                <el-radio v-model="form.inRoom" label="否">否</el-radio>
              </el-form-item>
            </el-form>
            <template #footer>
